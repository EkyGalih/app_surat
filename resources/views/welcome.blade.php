...
<div class="row top_tiles">
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <div class="count">
        <?php $countS = App\SuratMasuk::count(); ?>
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <div class="count">
        <?php $und = App\SuratMasuk::where('status_smumum', 'read')->count() ?>
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <div class="count">
        <?php $sm = App\Undangan::where('status_smund', 'read')->count() ?>
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <?php $count = App\Filesk::where('status', 'unread')->count(); ?>
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <div class="count">
        <?php $sksatker = App\Sksatker::count(); ?>
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <div class="count">
        <?php $skppdttl = App\Sksppdttl::count(); ?>
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <div class="count">
        <?php $skppdkttl = App\Sksppkttl::count(); ?>
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <div class="count">
        <?php $count = App\Distribusi::where('smund_id', '!=', NULL)->get()->count(); ?>
        <div class="count">{{ $count }}</div>
      </div>
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="tile-stats">
      ...
      <div class="count">
        <?php $count = App\Distribusi::where('smumum_id', '!=', NULL)->get()->count(); ?>
        <div class="count">{{ $count }}</div>
      </div>
