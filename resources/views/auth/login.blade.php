    ...
    <div id="wrapper">
      <div id="login" class="animate form">
        <section class="login_content">
          ...
          <div class="separator">
            <div>
              <h1><img src="{{ asset('assets/images/logo_pu.jpg') }}" style="height: 26px;"></i> BWS NT I</h1>

              <p>©2017 Surat Masuk &amp; Surat Keluar. Eky Galih Gunanda, STMIK Bumigora Mataram. Privacy and Terms</p>
            </div>
          </div>
        </form>
        <!-- form -->
