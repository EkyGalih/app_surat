			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					...
					<div class="navbar nav_title" style="border: 0;">
						<a href="{{ url('welcome') }}" class="site_title"><img src="{{ asset('assets/images/logo_pu.jpg') }}" height="28px" width="35px" class="img-rounded" alt="Logo BWS NT I"> 
							<span>BWS NT I</span></a>
						</div>
						...
						<div class="profile">
							...
							<div class="profile_info">
								...
								<h2><strong><u>{{ Auth::user()->nama_lengkap }}</u></strong> BWS NT I</h2>
								<br/>
								<br/>
							</div>
						</div>
										...
										<li>
											<a>
												...
												<ul class="nav child_menu" style="display: none">
													...
													<li><a href="{{ url('suratmasuk') }}">Surat Masuk BWS NT I</a>
													</li>
												</ul>
											</li>
											<li>
												<a>
													...
													<ul class="nav child_menu" style="display: none">
														<li>
															<a href="{{ url('skbws') }}">Surat Keluar BWS NT I</a>
														</li>
														<li>
															<a href="{{ url('sksppd') }}">Surat Keluar SPPD BWS NT I</a>
														</li>
														<li>
												...
												@endif
												@if(Auth::user()->divisi != 'KETUA BWS NT I' && Auth::user()->divisi != 'Administrator')
												<li>
												...
												@endif
												@if(Auth::user()->divisi != 'Agendaris' && Auth::user()->divisi != 'KETUA BWS NT I' && Auth::user()->divisi != 'Administrator')
												<li>
													<a href="{{ url('/filesk') }}">
												...
												<li>
													<a href="{{ url('/divisi') }}">
														<i class="fa fa-book"></i> Divisi BWS
													</a>
												</li>
												@endif
